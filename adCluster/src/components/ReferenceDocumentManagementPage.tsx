  ...
  return (
    <div className="p-5 bg-gray-100 min-h-screen">
      ...
      <div className="bg-white rounded-lg shadow-sm p-6 mb-5">
        <div className="mb-5">
          <h1 className="text-2xl font-semibold text-gray-800 mb-1">🔍 참고문서</h1>
          <p className="text-gray-500">연구 프로젝트 및 문서를 참고문서로 관리하고 검색하세요</p>
        </div>
        ...
        <div className="relative mb-5">
          <input 
            ...
            placeholder="검색어를 입력하세요 (예: 참고문서, 연구 자료, 외부 문서 등)"
            value={searchTerm}
      ...
      <div className="bg-white rounded-lg shadow-sm p-6">
        <div className="flex justify-between items-center mb-5">
          <h2 className="text-xl font-semibold text-gray-800">참고문서 검색 결과</h2>
