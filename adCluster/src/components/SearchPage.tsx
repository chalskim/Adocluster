...
const SearchPage: React.FC = () => {
  ...
  const [activeScope, setActiveScope] = useState<string>('내 프로젝트');
  const [activeFilter, setActiveFilter] = useState<string>('전체');
  const [sortBy, setSortBy] = useState<string>('최근 편집일');

  const scopes = ['내 문서', '내 프로젝트', '전체 공개 문서'];
  const filters = ['전체', '문서', '프로젝트', '이미지', 'PDF'];
  const sortOptions = ['최근 편집일', '관련도', '제목', '작성일'];

  const searchResults: SearchResult[] = [
    {
      id: 1,
      title: '웹사이트 리디자인 프로젝트 계획서',
      type: 'document',
      preview: '본 문서는 웹사이트 리디자인 프로젝트의 전체 계획을 담고 있습니다. 프로젝트 목표, 범위, 일정, 리소스 배분에 대한 상세 내용을 포함하고 있습니다. UI/UX 개선 방향과 기술 스택도 명시되어 있습니다...',
      author: {
        name: '김개발',
        avatar: 'K'
      },
    ...
    },
    {
      ...
      type: 'project',
      preview: '웹사이트 리디자인 프로젝트의 메인 프로젝트 폴더입니다. 하위에 디자인, 개발, 테스트 관련 문서들이 포함되어 있습니다. 현재 진행 상황은 60%이며, 예상 완료일은 2023.12.30입니다.',
      author: {
        name: '박매니저',
        avatar: 'P'
      },
    ...
    {
      id: 4,
      title: '웹사이트 리디자인 프로젝트 진행 보고서.pdf',
      type: 'pdf',
      preview: '11월 3주차 프로젝트 진행 상황 보고서입니다. 현재까지의 성과, 발생한 이슈, 다음 주 계획이 포함되어 있습니다. 예산 사용 현황과 리스크 관리 계획도 상세히 기술되어 있습니다.',
      author: {
        name: '최분석',
        avatar: 'C'
      },
    ...
    <div className="p-5 bg-gray-100 min-h-screen">
      ...
      <div className="bg-white rounded-lg shadow-sm p-6 mb-5">
        <div className="mb-5">
          ...
          <p className="text-gray-500">프로젝트, 문서, 내용을 빠르게 찾아보세요</p>
        </div>
        ...
        <div className="relative mb-5">
          <input 
            ...
            placeholder="검색어를 입력하세요 (예: 프로젝트 계획, API 문서, 디자인 가이드 등)"
            value={searchTerm}
