...
function locale_default(locale3) {
  ...
  function newFormat(specifier) {
    ...
    var fill = specifier.fill, align = specifier.align, sign2 = specifier.sign, symbol = specifier.symbol, zero4 = specifier.zero, width2 = specifier.width, comma = specifier.comma, precision = specifier.precision, trim = specifier.trim, type = specifier.type;
    ...
    function format2(value) {
      ...
      if (comma && zero4) value = group2(padding + value, padding.length ? width2 - valueSuffix.length : Infinity), padding = "";
      switch (align) {
        case "<":
...
function transformer3() {
  var x0 = 0, x1 = 0.5, x2 = 1, s2 = 1, t03, t13, t22, k10, k21, interpolator = identity3, transform2, clamp = false, unknown;
  function scale(x3) {
...
function order_default() {
  for (var groups2 = this._groups, j = -1, m = groups2.length; ++j < m; ) {
    for (var group2 = groups2[j], i = group2.length - 1, next2 = group2[i], node; --i >= 0; ) {
      if (node = group2[i]) {
...
var init_back = __esm({
  "node_modules/d3-ease/src/back.js"() {
    ...
    backInOut = (function custom13(s2) {
      s2 = +s2;
...
var tau3, amplitude, period, elasticIn, elasticOut, elasticInOut;
var init_elastic = __esm({
  "node_modules/d3-ease/src/elastic.js"() {
    ...
    amplitude = 1;
    period = 0.3;
    elasticIn = (function custom14(a2, p) {
    ...
    elasticOut = (function custom15(a2, p) {
      var s2 = Math.asin(1 / (a2 = Math.max(1, a2))) * (p /= tau3);
    ...
    elasticInOut = (function custom16(a2, p) {
      var s2 = Math.asin(1 / (a2 = Math.max(1, a2))) * (p /= tau3);
    ...
    function annotations(options) {
      ...
      return function(parentSelection) {
        parentSelection.each(function() {
          ...
          const pathEnter = path2.enter().append("path");
          path2.merge(pathEnter).attr("stroke", "#eee").attr("d", line);
          path2.exit().remove();
          ...
          text.merge(textEnter).text(function(d) {
            return d.text;
          }).attr("y", function(d) {
            return d.hasX ? 3 : 0;
          }).attr("x", function(d) {
...
var require_utils = __commonJS({
  "node_modules/function-plot/dist/utils.js"(exports) {
    ...
    var utils = {
      ...
      color: function(data, index2) {
        const indexModLenColor = index2 % globals_1.default.COLORS.length;
...
var require_Lexer = __commonJS({
  "node_modules/mr-parser/lib/Lexer.js"(exports, module) {
    ...
    Lexer.prototype.throwError = function(message, index2) {
      index2 = typeof index2 === "undefined" ? this.index : index2;
      var error = new Error(message + " at index " + index2);
      error.index = index2;
...
var require_extend = __commonJS({
  "node_modules/extend/index.js"(exports, module) {
    ...
    module.exports = function extend2() {
      var options, name, src, copy3, copyIsArray, clone2;
          ...
          for (name in options) {
            ...
            if (target !== copy3) {
              if (deep && copy3 && (isPlainObject(copy3) || (copyIsArray = isArray(copy3)))) {
                ...
                setProperty(target, { name, newValue: extend2(deep, clone2, copy3) });
...
var import_nextafter, cache, round, round_default2;
var init_round2 = __esm({
  "node_modules/interval-arithmetic/lib-esm/round.js"() {
    ...
    round = {
       ...
       */
      disable() {
        cache.next = cache.prev = identity6;
      },
      /**
...
var init_interval3 = __esm({
  "node_modules/interval-arithmetic/lib-esm/interval.js"() {
    ...
    _Interval = class __Interval {
       ...
       */
      bounded(lo, hi) {
        return this.set(round_default2.prev(lo), round_default2.next(hi));
      }
      /**
       ...
       */
      open(lo, hi) {
        return this.assign(round_default2.safeNext(lo), round_default2.safePrev(hi));
      }
      /**
       ...
       */
      halfOpenLeft(lo, hi) {
        return this.assign(round_default2.safeNext(lo), hi);
      }
      /**
       * Sets the endpoints of this interval to the half open interval `[lo, hi)`
       *
       ...
       */
      halfOpenRight(lo, hi) {
        return this.assign(lo, round_default2.safePrev(hi));
      }
      /**
...
var piLow, piHigh, constants2, constants_default;
var init_constants = __esm({
  "node_modules/interval-arithmetic/lib-esm/constants.js"() {
    ...
    constants2 = {
       ...
       */
      get E() {
        return new Interval(round_default2.prev(Math.E), round_default2.next(Math.E));
      },
      /**
       ...
       */
      get PI_HALF() {
        return new Interval(constants2.PI_HALF_LOW, constants2.PI_HALF_HIGH);
      },
      /**
       ...
       */
      get PI_TWICE() {
        return new Interval(constants2.PI_TWICE_LOW, constants2.PI_TWICE_HIGH);
      },
      /**
...
function nonZero(x2, y2) {
  ...
  if (xh < 0) {
    if (yh < 0) {
      out.lo = round_default2.divLo(xh, yl);
      out.hi = round_default2.divHi(xl, yh);
    } else {
      out.lo = round_default2.divLo(xl, yl);
      out.hi = round_default2.divHi(xh, yh);
    }
  } else if (xl < 0) {
    if (yh < 0) {
      out.lo = round_default2.divLo(xh, yh);
      out.hi = round_default2.divHi(xl, yh);
    } else {
      out.lo = round_default2.divLo(xl, yl);
      out.hi = round_default2.divHi(xh, yl);
    }
  } else {
    if (yh < 0) {
      out.lo = round_default2.divLo(xh, yh);
      out.hi = round_default2.divHi(xl, yl);
    } else {
      out.lo = round_default2.divLo(xl, yh);
      out.hi = round_default2.divHi(xh, yl);
    }
  }
  return out;
...
function positive(x2, v) {
  ...
  if (x2.hi < 0) {
    return new Interval(Number.NEGATIVE_INFINITY, round_default2.divHi(x2.hi, v));
  } else {
    return new Interval(round_default2.divLo(x2.lo, v), Number.POSITIVE_INFINITY);
  }
}
function negative(x2, v) {
  ...
  if (x2.hi < 0) {
    return new Interval(round_default2.divLo(x2.hi, v), Number.POSITIVE_INFINITY);
  } else {
    return new Interval(Number.NEGATIVE_INFINITY, round_default2.divHi(x2.lo, v));
  }
}
function zero3(x2) {
  if (x2.lo === 0 && x2.hi === 0) {
...
function add(x2, y2) {
  return new Interval(round_default2.addLo(x2.lo, y2.lo), round_default2.addHi(x2.hi, y2.hi));
}
function subtract(x2, y2) {
  return new Interval(round_default2.subLo(x2.lo, y2.hi), round_default2.subHi(x2.hi, y2.lo));
}
function multiply(x2, y2) {
  ...
  if (xl < 0) {
    if (xh > 0) {
      if (yl < 0) {
        if (yh > 0) {
          out.lo = Math.min(round_default2.mulLo(xl, yh), round_default2.mulLo(xh, yl));
          out.hi = Math.max(round_default2.mulHi(xl, yl), round_default2.mulHi(xh, yh));
        } else {
          out.lo = round_default2.mulLo(xh, yl);
          out.hi = round_default2.mulHi(xl, yl);
        }
      } else {
        if (yh > 0) {
          out.lo = round_default2.mulLo(xl, yh);
          out.hi = round_default2.mulHi(xh, yh);
        } else {
          out.lo = 0;
          out.hi = 0;
        }
      ...
      if (yl < 0) {
        if (yh > 0) {
          ...
          out.lo = round_default2.mulLo(xh, yh);
          out.hi = round_default2.mulHi(xl, yl);
        }
      } else {
        if (yh > 0) {
          out.lo = round_default2.mulLo(xl, yh);
          out.hi = round_default2.mulHi(xh, yl);
        } else {
          out.lo = 0;
          out.hi = 0;
        }
    ...
    if (xh > 0) {
      if (yl < 0) {
        if (yh > 0) {
          ...
          out.lo = round_default2.mulLo(xh, yl);
          out.hi = round_default2.mulHi(xl, yh);
        }
      } else {
        if (yh > 0) {
          out.lo = round_default2.mulLo(xl, yl);
          out.hi = round_default2.mulHi(xh, yh);
        } else {
          out.lo = 0;
          out.hi = 0;
  ...
  if (zeroIn(x2)) {
    if (x2.lo !== 0) {
      if (x2.hi !== 0) {
        ...
        return new Interval(Number.NEGATIVE_INFINITY, round_default2.divHi(1, x2.lo));
      }
    } else {
      if (x2.hi !== 0) {
        return new Interval(round_default2.divLo(1, x2.hi), Number.POSITIVE_INFINITY);
      } else {
        return constants_default.EMPTY;
      }
    }
  } else {
    return new Interval(round_default2.divLo(1, x2.hi), round_default2.divHi(1, x2.lo));
  }
}
function pow2(x2, power) {
  ...
  if (Number.isSafeInteger(power)) {
    if (x2.hi < 0) {
      const yl = round_default2.powLo(-x2.hi, power);
      const yh = round_default2.powHi(-x2.lo, power);
      if ((power & 1) === 1) {
      ...
      if ((power & 1) === 1) {
        return new Interval(-round_default2.powLo(-x2.lo, power), round_default2.powHi(x2.hi, power));
      } else {
        return new Interval(0, round_default2.powHi(Math.max(-x2.lo, x2.hi), power));
      }
    } else {
      return new Interval(round_default2.powLo(x2.lo, power), round_default2.powHi(x2.hi, power));
    }
...
function nthRoot(x2, n) {
  ...
  if (x2.hi < 0) {
    if (Number.isSafeInteger(n) && (n & 1) === 1) {
      const yl = round_default2.powHi(-x2.lo, power);
      const yh = round_default2.powLo(-x2.hi, power);
      return new Interval(-yl, -yh);
    }
    return constants_default.EMPTY;
  } else if (x2.lo < 0) {
    const yp = round_default2.powHi(x2.hi, power);
    if (Number.isSafeInteger(n) && (n & 1) === 1) {
      const yn = -round_default2.powHi(-x2.lo, power);
...
function exp(x2) {
  ...
  return new Interval(round_default2.expLo(x2.lo), round_default2.expHi(x2.hi));
}
function log2(x2) {
  if (isEmpty(x2)) {
    return constants_default.EMPTY;
  }
  const l = x2.lo <= 0 ? Number.NEGATIVE_INFINITY : round_default2.logLo(x2.lo);
  return new Interval(l, round_default2.logHi(x2.hi));
}
function log10(x2) {
  if (isEmpty(x2)) {
    return constants_default.EMPTY;
  }
  return div(log2(x2), LOG_EXP_10);
}
function log22(x2) {
  if (isEmpty(x2)) {
    return constants_default.EMPTY;
  }
  return div(log2(x2), LOG_EXP_2);
}
function hull(x2, y2) {
...
function width(x2) {
  ...
  return round_default2.subHi(x2.hi, x2.lo);
}
function abs2(x2) {
...
var init_misc = __esm({
  "node_modules/interval-arithmetic/lib-esm/operations/misc.js"() {
    ...
    init_arithmetic();
    ln = log2;
    LOG_EXP_10 = log2(new Interval(10, 10));
    LOG_EXP_2 = log2(new Interval(2, 2));
    wid = width;
  }
});
...
function handleNegative(interval2) {
  if (interval2.lo < 0) {
    if (interval2.lo === -Infinity) {
      ...
      const n = Math.ceil(-interval2.lo / constants_default.PI_TWICE_LOW);
      interval2.lo += constants_default.PI_TWICE_LOW * n;
      interval2.hi += constants_default.PI_TWICE_LOW * n;
    }
  }
  return interval2;
}
function cos2(x2) {
  ...
  const lo = t.lo;
  const hi = t.hi;
  const rlo = round_default2.cosLo(hi);
  const rhi = round_default2.cosHi(lo);
...
function tan(x2) {
  ...
  const cache2 = new Interval().set(x2.lo, x2.hi);
  handleNegative(cache2);
  const pi4 = constants_default.PI;
  let t = fmod(cache2, pi4);
  ...
  return new Interval(round_default2.tanLo(t.lo), round_default2.tanHi(t.hi));
}
function asin2(x2) {
  if (isEmpty(x2) || x2.hi < -1 || x2.lo > 1) {
    return constants_default.EMPTY;
  }
  const lo = x2.lo <= -1 ? -constants_default.PI_HALF_HIGH : round_default2.asinLo(x2.lo);
  const hi = x2.hi >= 1 ? constants_default.PI_HALF_HIGH : round_default2.asinHi(x2.hi);
  return new Interval(lo, hi);
}
function acos2(x2) {
  if (isEmpty(x2) || x2.hi < -1 || x2.lo > 1) {
  ...
  const lo = x2.hi >= 1 ? 0 : round_default2.acosLo(x2.hi);
  const hi = x2.lo <= -1 ? constants_default.PI_HIGH : round_default2.acosHi(x2.lo);
  return new Interval(lo, hi);
}
function atan(x2) {
  if (isEmpty(x2)) {
  ...
  return new Interval(round_default2.atanLo(x2.lo), round_default2.atanHi(x2.hi));
}
function sinh2(x2) {
  if (isEmpty(x2)) {
    return constants_default.EMPTY;
  }
  return new Interval(round_default2.sinhLo(x2.lo), round_default2.sinhHi(x2.hi));
}
function cosh2(x2) {
  if (isEmpty(x2)) {
    return constants_default.EMPTY;
  ...
  if (x2.hi < 0) {
    return new Interval(round_default2.coshLo(x2.hi), round_default2.coshHi(x2.lo));
  } else if (x2.lo >= 0) {
    return new Interval(round_default2.coshLo(x2.lo), round_default2.coshHi(x2.hi));
  } else {
    return new Interval(1, round_default2.coshHi(-x2.lo > x2.hi ? x2.lo : x2.hi));
  }
}
function tanh2(x2) {
  if (isEmpty(x2)) {
  ...
  return new Interval(round_default2.tanhLo(x2.lo), round_default2.tanhHi(x2.hi));
}
...
var init_lib_esm = __esm({
  "node_modules/interval-arithmetic/lib-esm/index.js"() {
    ...
    init_misc();
    init_utils();
    MixedInterval = Object.assign(Interval, constants_default, round_default2, misc_exports, utils_exports, relational_exports, arithmetic_exports, algebra_exports, trigonometric_exports, { round: round_default2 });
    ...
    function mouseTip(config) {
      ...
      tip.move = function(coordinates) {
        ...
        if (closestIndex !== -1) {
          ...
          const clampX = utils_1.default.clamp(x2, xScale.invert(-MARGIN), xScale.invert(width2 + MARGIN));
...
var require_builtIn = __commonJS({
  "node_modules/function-plot/dist/samplers/builtIn.js"(exports) {
    ...
    function linear4(samplerParams) {
    ...
    function polyline(chart) {
      function plotLine(selection2) {
        selection2.each(function(d) {
          ...
          const index2 = d.index;
          const evaluatedData = (0, evaluate_1.default)(chart, d);
          const color2 = utils_1.default.color(d, index2);
    ...
    function interval2(chart) {
      ...
      function plotLine(selection2) {
        selection2.each(function(d) {
          ...
          const selection3 = innerSelection.merge(innerSelectionEnter).attr("stroke-width", minWidthHeight).attr("stroke", utils_1.default.color(d, index2)).attr("opacity", closed ? 0.5 : 1).attr("d", function(d2) {
    ...
    function Scatter(chart) {
      ...
      function scatter(selection2) {
        selection2.each(function(d) {
          ...
          const cls = `scatter scatter-${index2}`;
    ...
    var Chart = class _Chart extends events_1.default.EventEmitter {
      ...
      buildContent() {
        ...
        graphs.merge(graphsEnter).each(function(d, index2) {
          ...
          selection2.call(globals_1.default.graphTypes[d.graphType](self));
      ...
      setUpEventListeners() {
        ...
        const events = {
          ...
          "tip:update": function({ x: x2, y: y2, index: index2 }) {
